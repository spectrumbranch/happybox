...
var responseHandler = function() {
	...
	if (response == "userAlreadyExists") {
		$('#HappyBoxRegisterModalMessage').empty()
			...
			.append('<br /><br /><input type="button" value="Okay!" class="button success radius" onclick="$(\'#HappyBoxRegisterModal\').foundation(\'reveal\', \'close\')"/>');
		$('#HappyBoxRegisterModal').foundation('reveal', 'open');
	}
};
