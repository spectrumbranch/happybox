...
var responseHandler = function() {
	...
	if (response == "registerSuccessful") {
		$('#HappyBoxLoginModalMessage').empty()
			.append('Registration was successful! Please check your email for a confirmation link.')
			.append('<br /><br /><input type="button" value="Okay!" class="button success radius" onclick="$(\'#HappyBoxLoginModal\').foundation(\'reveal\', \'close\')"/>');
		$('#HappyBoxLoginModal').foundation('reveal', 'open');
